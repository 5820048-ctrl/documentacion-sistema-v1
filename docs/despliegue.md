...
- **Base de Datos:** PostgreSQL v15.8
...
Crear un archivo llamado `.env` en la raíz del proyecto tomando como base el archivo `.env.example`, definiendo los parámetros de conexión:
